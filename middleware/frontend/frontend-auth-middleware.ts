...
import CartOrdersModel from '../../src/model/frontend/cart-order-model';
...
const frontendAuthAndUnAuthMiddleware = async (req: CustomRequest, res: Response, next: NextFunction) => {
    try {
        const authHeader = req.header('Authorization');
 ...
 export default frontendAuthAndUnAuthMiddleware;
