...
class SapController extends BaseController {
    ...
    async getOrderDetails(req: Request, res: Response): Promise<any> {
        try {
            const { country = '', orderId = '', orderIdAfter = '', paymentMethod = '', customer = '', fromDate, endDate, orderStatus = '', getaddress = '1', getcustomer = '0', getpaymentmethod = '0', page_size = 1, limit = 10, sortby = '', sortorder = '', } = req.query as OrderQueryParams;
