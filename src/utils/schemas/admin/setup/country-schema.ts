...
export const countrySchema = zod.object({
    ...
    countrySubDomain: zod.string({ required_error: 'Sub Domain is required', }).min(2, 'Sub Domain is should be 2 chars minimum').max(3, 'Sub Domain is should be 3 chars maximum'),
