...
import { attributeDetailLanguageFieldsReplace, attributeDetailLookup, attributeLanguageFieldsReplace, attributeLookup, attributeProject, productFinalProject } from '../../../utils/config/product-config';
