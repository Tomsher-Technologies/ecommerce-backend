...
router.post('/import-product-price-excel', (0, admin_user_permission_roll_middleware_1.default)({ permissionBlock: permission_blocks_1.permissionBlocks.ecommerce.products, writeOnly: 1 }), uploadExcel.single('productExcel'), products_controller_1.default.importProductPriceExcel);
