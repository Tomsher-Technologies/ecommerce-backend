...
const task_log_controller_1 = __importDefault(require("../../../src/controllers/admin/general/task-log-controller"));
const router = express_1.default.Router();
router.use(auth_middleware_1.default);
router.get('/', response_status_1.logResponseStatus, (0, admin_user_permission_roll_middleware_1.default)({ permissionBlock: permission_blocks_1.permissionBlocks.other.taskLog, readOnly: 1 }), task_log_controller_1.default.findAllTaskLogs);
