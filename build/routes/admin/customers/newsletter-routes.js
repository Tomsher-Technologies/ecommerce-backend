...
const newsletter_controller_1 = __importDefault(require("../../../src/controllers/admin/customer/newsletter-controller"));
const router = express_1.default.Router();
router.use(auth_middleware_1.default);
router.get('/', (0, admin_user_permission_roll_middleware_1.default)({ permissionBlock: permission_blocks_1.permissionBlocks.customers.newsletter, readOnly: 1 }), newsletter_controller_1.default.findAll);
