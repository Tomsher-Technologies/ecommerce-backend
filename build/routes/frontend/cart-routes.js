...
router.get('/tap-success-response', response_status_1.logResponseStatus, checkout_controller_1.default.tapSuccessResponse);
router.get('/tap-failure-response', response_status_1.logResponseStatus, checkout_controller_1.default.tapSuccessResponse);
