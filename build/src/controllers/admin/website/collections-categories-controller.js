...
const collection_category_shema_1 = require("../../../utils/schemas/admin/website/collection-category-shema");
...
class CollectionsCategoriesController extends base_controller_1.default {
    async findAll(req, res) {
        try {
            ...
            const collections = await collections_categories_service_1.default.findAll({
            ...
            return controller.sendSuccessResponse(res, {
                ...
                totalCount: await collections_categories_service_1.default.getTotalCount(query),
                message: 'Success!'
            }, 200);
        }
        catch (error) {
    ...
    async create(req, res) {
        try {
            const validatedData = collection_category_shema_1.collectionCategorySchema.safeParse(req.body);
            ...
            if (validatedData.success) {
                ...
                const newCollection = await collections_categories_service_1.default.create(collectionData);
                if (newCollection) {
                    ...
                    return controller.sendSuccessResponse(res, {
                        ...
                        sourceCollection: collections_1.collections.website.collectionsCategories,
                        referenceData: JSON.stringify(newCollection, null, 2),
                        sourceFromId: newCollection._id,
                        sourceFrom: task_log_1.adminTaskLog.website.collectionsCategories,
    ...
    async findOne(req, res) {
        try {
            ...
            if (collectionId) {
                const collection = await collections_categories_service_1.default.findOne(collectionId);
                if (collection) {
                    const collectionCategories = await collections_categories_service_1.default.findCollectionCategories(collection.collectionsCategories);
    ...
    async destroy(req, res) {
        try {
            ...
            if (collectionId) {
                const collection = await collections_categories_service_1.default.findOne(collectionId);
                if (collection) {
                    await collections_categories_service_1.default.destroy(collectionId);
                    const existingLanguageValues = await general_service_1.default.findOneLanguageValues(multi_languages_1.multiLanguageSources.website.collectionsCategories, collectionId);
...
exports.default = new CollectionsCategoriesController();
