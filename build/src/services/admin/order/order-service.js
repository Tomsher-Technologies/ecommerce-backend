...
class OrderService {
    async OrderList(options) {
        ...
        const pipeline = [
            ...
            ...(!getTotalCount ? [cart_order_config_1.paymentMethodLookup, cart_order_config_1.customerLookup, ...cart_order_config_1.pickupStoreLookupPipeline, cart_order_config_1.orderListObjectLookup] : []),
