...
exports.collectionCategorylanguageFieldsReplace = exports.collectionProductlanguageFieldsReplace = exports.bannerlanguageFieldsReplace = exports.sliderlanguageFieldsReplace = void 0;
...
exports.collectionProductlanguageFieldsReplace = {
    $addFields: {
        collectionTitle: {
            $cond: {
                if: {
