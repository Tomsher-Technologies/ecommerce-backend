...
exports.bannerPositionSchema = exports.bannerStatusSchema = exports.bannerSchema = void 0;
...
exports.bannerSchema = zod_1.z.object({
    ...
    blocks: zod_1.z.custom((val) => isNonNegativeInteger(val), {
        message: 'Position must be a non-negative integer or a string that can be converted to a non-negative integer'
    }),
    bannerImages: zod_1.z.any({ required_error: 'Slider image is required' }),
...
exports.bannerPositionSchema = zod_1.z.object({
    position: zod_1.z.custom((val) => isNonNegativeInteger(val), {
        message: 'Position must be a non-negative integer or a string that can be converted to a non-negative integer'
    }),
});
