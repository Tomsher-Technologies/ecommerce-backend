...
exports.collectionBrandSchema = void 0;
const zod_1 = require("zod");
exports.collectionBrandSchema = zod_1.z.object({
    ...
    collectionsBrands: zod_1.z.any({ required_error: 'Collection brand is required', }),
